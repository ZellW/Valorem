...
# yaml
yaml_file <- "C:/Users/cweaver/Documents/Github/Valorem/churn/churn_updated.yaml"
...
#' # Task Summary
#+ echo=FALSE
#' - The metadata (location, numerical columns, target, etc.) is - *"C:/Users/cweaver/Documents/Github/Valorem/churn/churn_updated.yaml"*
