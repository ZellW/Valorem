...
This document walks through the Digital Insight Workshop methodology to predict different churn models for ClubReady.
...
This section walks through the initial Exploratory Data Analysis supporting the potential algorithm development to predict different churn models for ClubReady.  The section is organized as follows:
...
Working with ClubReady, Valorem developed SQL scripts capturing raw data ClubReady data in csv format.
...
```{r message=FALSE, warning=FALSE}
Users <- read_csv("C:/Users/bllewellyn/OneDrive - Valorem/ClubReady/Digital Insight Workshop/CSV Data/Initial Data Sets/Users.csv", col_types = cols(StoreId = col_integer()), progress = FALSE)
myData <- Users
rm(Users)
```
...
```{r}
finalstoredata <- read_csv("C:/Users/bllewellyn/OneDrive - Valorem/ClubReady/Digital Insight Workshop/CSV Data/Final Data Sets/Stores_2017_12_11.csv", col_types = cols())
...
```{r}
include_graphics("C:/Users/bllewellyn/OneDrive - Valorem/ClubReady/Digital Insight Workshop/Kitchen Sink.jpg")
```
...
```{r}
finaluserdata <- read_csv("C:/Users/bllewellyn/OneDrive - Valorem/ClubReady/Digital Insight Workshop/CSV Data/Final Data Sets/Users_1M_2017_12_12.csv", col_types = cols(
...
```{r}
include_graphics("C:/Users/bllewellyn/OneDrive - Valorem/ClubReady/Digital Insight Workshop/Permutation Feature Importance.jpg")
```
